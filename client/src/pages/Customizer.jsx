...
const Customizer = () => {
  ...
  const handleSubmit = async (type) => {
    ...
    const response = await fetch('https://project-3js-ai-1xsf.onrender.com/api/v1/dalle', {
        method: 'POST',
        headers: {
      ...
      if(data && data.photo) handleDecals(type, `data:image/png;base64,${data.photo}`)
  ...
  const handleActiveFilterTab = (tabName) => {
    ...
    setActiveFilterTab({...activeFilterTab, [tabName]: !activeFilterTab[tabName]})
